...
class SACwithEncoder(OffPolicyRLModel):
    """
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000,
        ...
        super(SACwithEncoder, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose,
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("model", reuse=False):
                    ...
                    self.deterministic_action, policy_out, logp_pi, pi_h = self.policy_tf.make_actor(self.processed_obs_ph)
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    # Encoding loss
                    target_enc = tf.stop_gradient(pi_h)
                    enc_loss = 0.5 * tf.reduce_mean((target_enc - target_enc) ** 2)
                    ...
                    policy_losses = policy_kl_loss + enc_loss
                    ...
                    policy_train_op = policy_optimizer.minimize(policy_losses, var_list=tf_util.get_trainable_vars('model/pi'))
                    ...
                    with tf.control_dependencies([policy_train_op]):
                        ...
                        self.infos_names = ['enc_loss', 'policy_kl_loss', 'qf1_loss', 'qf2_loss', 'value_loss', 'entropy']
                        # All ops to call during one training step
                        self.step_ops = [enc_loss, policy_kl_loss, qf1_loss, qf2_loss,
